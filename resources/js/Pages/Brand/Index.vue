...
let brandUrl = computed(() => {
    let url = new URL(route("brand.index"));
                            ...
                            >
                                ...
                                >
                                    <div class="flex items-center space-x-4">
                                        <button
                                            @click="editButton(brand)"
                                            type="button"
                                            aria-controls="drawer-update-brand"
